...
{ 
    ...
    { 
        ...
        [HttpDelete]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/store/order/{orderId}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/store/inventory")]
        ...
        [HttpPost]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/store/order")]
        [ValidateModelState]

...
{ 
    ...
    { 
        ...
        [HttpPost]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/user")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/user/createWithArray")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpPost]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/user/createWithList")]
        [ValidateModelState]
        ...
        [HttpDelete]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/user/{username}")]
        [ValidateModelState]
        ...
        [HttpGet]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/user/login")]
        [ValidateModelState]
        ...
        /// <response code="0">successful operation</response>
        [HttpGet]
        [Route("/Abacus51/OpenAPIBitbucket/1.0.0/user/logout")]
        [ValidateModelState]
